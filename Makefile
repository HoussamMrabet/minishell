...
#    Updated: 2024/04/21 17:38:15 by hmrabet          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c heap.c utils-0.c utils-1.c utils-2.c env.c signals.c init_data.c splitpaths.c lexer-0.c lexer-1.c lexer-2.c
OBJS = $(SRCS:.c=.o)
